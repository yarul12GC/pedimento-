<body>
    <div class="modal fade" id="bloque131" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="patente" id="patente" value="<?php echo htmlspecialchars($datodpm['patente']); ?>" readonly maxlength="4">
                                </div>
                                <div class="form-group">
                                    <label for="pedimento">Pedimento:</label>
                                    <input type="text" class="form-control" name="pedimento" id="pedimento" value="<?php echo htmlspecialchars($datodpm['ultimo_digito_anio'] . $datodpm['numeracion_progresiva']); ?>" readonly maxlength="7">
                                </div>
                                <div class="form-group">
                                    <label for="aduana">Aduana:</label>
                                    <input type="text" class="form-control" name="aduana" id="aduana" value="<?php echo htmlspecialchars($datotransac['clavea1'] . $datotransac['seccion']); ?>" readonly>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="importePago" id="importePago" value="<?php echo htmlspecialchars($rowt['total']); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="fechapago">Fecha Pago:</label>
                                    <input type="date" class="form-control" name="fechapago" id="fechapago" value="<?php echo $rowfech['pago']; ?>" readonly>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="editarBloque13_<?php echo $pedimento_id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 80vw;">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel"> <img src="../media/locenca.png" width="40px">
                ...
                <div class="modal-body">
                    ...
                    <form action="../admin/bloque13/Actualizardatosb13.php" method="POST">
                        <div class="row">
