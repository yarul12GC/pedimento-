...
<?php
    ...
    $last_idb16 = isset($_SESSION['bloques']['bloque16']) ? $_SESSION['bloques']['bloque16'] : null;

    if ($last_idb16 !== null) {
        $querybloque16 = "
       SELECT * FROM dembarque WHERE idembarque =$last_idb16";
        $resultbloque16 = $conexion->query($querybloque16);
        if ($resultbloque16 && $resultbloque16->num_rows > 0) {
            $datosb16 = $resultbloque16->fetch_assoc();
    ?>
