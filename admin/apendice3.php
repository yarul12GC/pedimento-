...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice3 ORDER BY idapendice3 ASC";
            $queryapendice3 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice3);
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider">
                    <?php while ($row = mysqli_fetch_array($queryapendice3)) { ?>
                        <tr>
                            <td> <?php echo $row['clave']; ?> </td>
                            <td> <?php echo $row['descripcion']; ?></td>
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice3']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice3']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/apendice3/registarApendice3.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <input type="hidden" name="idapendice3">
                        </div>
    ...
    <?php
    $queryapendice3 = mysqli_query($conexion, $consultar);
    while ($row = mysqli_fetch_array($queryapendice3)) {
        ?>

        <div class="modal fade" id="editar_<?php echo $row['idapendice3']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice3/actualizarapendice3.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="idapendice3" value="<?php echo $row['idapendice3']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice3) {
        if (confirm("¿Estás seguro de que deseas eliminar este Complemento?")) {
            window.location.href = 'apendice3/eliminarapendice3.php?idapendice3=' + idapendice3;
        }
    }
</script>