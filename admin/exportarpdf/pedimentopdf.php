...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; font-size: 6px; margin: 0; padding: 0;">
        <thead>
            <tr style="background-color: #6c757d; color: #ffffff;">
                <th colspan="14" style="text-align: center;">DEÓSITO REFERENCIADO - LINEA DE CAPTURA</th>
            </tr>
        </thead>
</table>';
...
if ($resultpagoe->num_rows > 0) {
    ...
    $html .= '
    <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse; width: 100%; font-size: 6px; margin: 0; padding: 0;">
        <tr>
    ...
    if (!empty($rowpe['barcode_image'])) {
        $barcode_image = base64_encode($rowpe['barcode_image']);
        $html .= '<img src="data:image/png;base64,' . $barcode_image . '" alt="Código de Barras" width="400" height="80">';
    } else {
        $html .= 'No se encontró el código de barras.';
    }
    ...
    $html .= '
        ...
        <tr>
            <th colspan="7" style="text-align: center; font-weight: bold;">***DEPÓSITO ELECTRÓNICO***</th>
        </tr>
        <tr>
            <th style="font-weight: bold; width: 8%;">PATENTE:</th>
    ...
    $html .= "<tr><td colspan='7' class='text-center'>No se encontraron registros en el cuadro de liquidación.</td></tr>";
}
