...
<td colspan="2" class="text-center">
    <button type="button" class="btn btn-success save-section" data-index="<?php echo $index; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-database-fill-up" viewBox="0 0 16 16">
