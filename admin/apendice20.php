...
<body>
                        ...
                        <tr>
                            ...
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice20']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice20']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/apendice20/registarApendice20.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <input type="hidden" name="idapendice20">
                        </div>
    ...
    <?php
    $queryapendice20 = mysqli_query($conexion, $consultar);
    while ($row = mysqli_fetch_array($queryapendice20)) {
        ?>

        <div class="modal fade" id="editar_<?php echo $row['idapendice20']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice20/actualizarapendice20.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="idapendice20" value="<?php echo $row['idapendice20']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice20) {
        if (confirm("¿Estás seguro de que deseas eliminar este usuario?")) {
            window.location.href = '../admin/apendice20/eliminarapendice20.php?idapendice20=' + idapendice20;
        }
    }
</script>