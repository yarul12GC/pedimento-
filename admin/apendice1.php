...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice1 ORDER BY idapendice1 ASC";
            $queryapendice1 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice1);
                        ...
                        <tr>
                            ...
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice1']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice1']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                ...
                <div class="modal-body">
                    <form action="../admin/apendice1/registarApendice1.php" method="post">
                        <div class="row">
                            ...
                            <input type="hidden" name="idapendice1">
                        </div>
    ...
    <?php
    $queryapendice1 = mysqli_query($conexion, $consultar);
    while ($row = mysqli_fetch_array($queryapendice1)) {
        ?>

        <div class="modal fade" id="editar_<?php echo $row['idapendice1']; ?>" tabindex="-1"
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice1/actualizarapendice1.php" method="post">
                            <div class="row">
                                ...
                                <input type="hidden" name="idapendice1" value="<?php echo $row['idapendice1']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice1) {
        if (confirm("¿Estás seguro de que deseas eliminar este Complemento?")) {
            window.location.href = 'apendice1/eliminarapendice1.php?idapendice1=' + idapendice1;
        }
    }
</script>