...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice16 ORDER BY idapendice16 ASC";
            $queryapendice16 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice16);
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider">
                    <?php while ($row = mysqli_fetch_array($queryapendice16)) { ?>
                        <tr>
                            <td> <?php echo $row['clave']; ?> </td>
                            <td> <?php echo $row['descripcion']; ?></td>
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice16']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice16']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/apendice16/registarApendice16.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <input type="hidden" name="idapendice16">
                        </div>
    ...
    <?php
    $queryapendice16 = mysqli_query($conexion, $consultar);
    while ($row = mysqli_fetch_array($queryapendice16)) {
        ?>

        <div class="modal fade" id="editar_<?php echo $row['idapendice16']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice16/actualizarapendice16.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="idapendice16" value="<?php echo $row['idapendice16']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice16) {
        if (confirm("¿Estás seguro de que deseas eliminar este usuario?")) {
            window.location.href = '../admin/apendice16/eliminarapendice16.php?idapendice16=' + idapendice16;
        }
    }
</script>