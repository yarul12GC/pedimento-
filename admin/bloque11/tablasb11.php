<body>
    ...
    if (!empty($ids_b11)) {
        ...
        FROM 
            cuadrodeliquidacion
        INNER JOIN 
            apendice12 ON cuadrodeliquidacion.idapendice12 = apendice12.idapendice12
        INNER JOIN 
            apendice13 ON cuadrodeliquidacion.idapendice13 = apendice13.idapendice13
        WHERE 
            cuadrodeliquidacion.idliquidacion IN ($ids_stringb11)";
        $resultbloque11 = $conexion->query($querybloque11);

        if ($resultbloque11 && $resultbloque11->num_rows > 0) {
    ?>
