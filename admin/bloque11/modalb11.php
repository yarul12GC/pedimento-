        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 80vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bloque-b-form" action="../admin/bloque11/insertardatosb11.php" method="post">
                    ...
                    <br>
                    <form id="bloque12-form" action="../admin/bloque12/insertardatosb12.php" method="POST">
                        <div class="row">
                            <div class="col-md-4">
        ...
        function addContribucionForm() {
            ...
            const formHtml = `
                <div class="row contribucion-form">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="agenteSelect">CONCEPTO (APENDICE 12)</label>
                            <select class="form-control" name="idapendice12[]" onchange="calculateSum()">
                                ...
                                <?php while ($apendice12 = $apendice12Result->fetch_assoc()) : ?>
                                    <option value="<?= $apendice12['idapendice12'] ?>"><?= $apendice12['clave12'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="agenteSelect">FORMA DE PAGO (APENDICE 13)</label>
                            <select class="form-control" name="idapendice13[]" onchange="calculateSum()">
                                ...
                                <?php while ($apendice13 = $apendice13Result->fetch_assoc()) : ?>
                                    <option value="<?= $apendice13['idapendice13'] ?>"><?= $apendice13['clave13'] . ' - ' . $apendice13['descripcion13'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    </div>
