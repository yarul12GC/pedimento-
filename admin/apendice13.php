...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice13 ORDER BY idapendice13 ASC";
            $queryapendice13 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice13);
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider">
                    <?php while ($row = mysqli_fetch_array($queryapendice13)) { ?>
                        <tr>
                            <td> <?php echo $row['clave']; ?> </td>
                            <td> <?php echo $row['descripcion']; ?></td>
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice13']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice13']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/apendice13/registarApendice13.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <input type="hidden" name="idapendice13">
                        </div>
    ...
    <?php
    $queryapendice13 = mysqli_query($conexion, $consultar);
    while ($row = mysqli_fetch_array($queryapendice13)) {
        ?>

        <div class="modal fade" id="editar_<?php echo $row['idapendice13']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice13/actualizarapendice13.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="idapendice13" value="<?php echo $row['idapendice13']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice13) {
        if (confirm("¿Estás seguro de que deseas eliminar este usuario?")) {
            window.location.href = '../admin/apendice13/eliminarapendice13.php?idapendice13=' + idapendice13;
        }
    }
</script>