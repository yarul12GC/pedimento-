...
<?php
    ...
    if ($last_idb2 !== null) {
        $querybloque2 = "
    SELECT ts.*, a15.clave AS clavea15, a1.clave AS clavea1, a1.seccion
    ...
    WHERE ts.idtransacciones = $last_idb2
    ";

        $resultbloque2 = $conexion->query($querybloque2);
        if ($resultbloque2 && $resultbloque2->num_rows > 0) {
            $datosb2 = $resultbloque2->fetch_assoc();
    ?>

            <table class="table table-bordered table-hover">
                <tr>
                    <th>DESTINO/ORIGEN</th>
                    <td><?php echo htmlspecialchars($datosb2['clavea15']); ?></td>
                    <th>TIPO DE CAMBIO</th>
                    <td><?php echo htmlspecialchars($datosb2['tipoCambio']); ?></td>
                    <th>PESO BRUTO</th>
                    <td><?php echo htmlspecialchars($datosb2['peso_bruto']); ?></td>
                    <th>ADUANA</th>
                    <td><?php echo htmlspecialchars($datosb2['clavea1'] . $datosb2['seccion']); ?></td>
                </tr>
            </table>
        <?php
        } else {
