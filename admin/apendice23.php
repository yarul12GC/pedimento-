...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice23 ORDER BY idapendice23 ASC";
            $queryapendice23 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice23);
                ...
                <div class="modal-body">
                    <form action="../admin/apendice23/registarApendice23.php" method="post">
                        <div class="row">
                            ...
                            <input type="hidden" name="idapendice23">
                        </div>
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice23/actualizarapendice23.php" method="post">
                            <div class="row">
                                ...
                                <input type="hidden" name="idapendice23" value="<?php echo $row['idapendice23']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice23) {
        if (confirm("¿Estás seguro de que deseas eliminar este usuario?")) {
            window.location.href = '../admin/apendice23/eliminarapendice23.php?idapendice23=' + idapendice23;
        }
    }
</script>