...
<body>
    ...
    <section class="zona1">
        ...
        <fieldset class="fiel">
            ...
            $consultar = "SELECT * FROM apendice4 ORDER BY idapendice4 ASC";
            $queryapendice4 = mysqli_query($conexion, $consultar);
            $cantidad = mysqli_num_rows($queryapendice4);
                        ...
                        <tr>
                            ...
                            <td class="cent">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editar_<?php echo $row['idapendice4']; ?>">Editar</button>
                                <button type="button" class="btn btn-danger"
                                    onclick="confirmarEliminar(<?php echo $row['idapendice4']; ?>)">Eliminar</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/apendice4/registarApendice4.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <input type="hidden" name="idapendice4">
                        </div>
        ...
        <div class="modal fade" id="editar_<?php echo $row['idapendice4']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 70vw;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../admin/apendice4/actualizarapendice4.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="idapendice4" value="<?php echo $row['idapendice4']; ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    ...
    function confirmarEliminar(idapendice4) {
        if (confirm("¿Estás seguro de que deseas eliminar este Complemento?")) {
            window.location.href = 'apendice4/eliminarapendice4.php?idapendice4=' + idapendice4;
        }
    }
</script>