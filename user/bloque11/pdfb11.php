...
SELECT cl.*, 
    ...
    a12_cl.descripcion AS descripcionAP,
...
if (!empty($cuadroLiquidacion)) {
    ...
    for ($i = 0; $i < $mitad; $i++) {
        ...
        if (isset($cuadroLiquidacion[$i])) {
            $html .= '
            <td style="text-align: center;">' . htmlspecialchars($cuadroLiquidacion[$i]['clavetpa12_cl'] . $cuadroLiquidacion[$i]['descripcionAP']) . '</td>
        ...
        if (isset($cuadroLiquidacion[$i + $mitad])) {
            $html .= '
            <td style="border-left: 1px solid black; text-align: center;">' . htmlspecialchars($cuadroLiquidacion[$i + $mitad]['clavetpa12_cl'] . $cuadroLiquidacion[$i + $mitad]['descripcionAP']) . '</td>
