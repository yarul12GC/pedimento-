        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 80vw;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form4" action="../user/bloque11/insertardatosb11.php" method="post">
                    ...
                    <form id="form5" action="../user/bloque12/insertardatosb12.php" method="post">
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="idapendice12[]" onchange="calculateSum()">
                                ...
                                $apendice12Result = $conexion->query("SELECT idapendice12, clave as clave12, descripcion AS descripcionAP FROM apendice12");
