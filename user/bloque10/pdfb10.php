...
SELECT 
    ...
    apendice12.descripcion AS descripcionAP12t
...
if ($resulttasasp->num_rows > 0) {
    ...
    while ($rowtsp = $resulttasasp->fetch_assoc()) {
        $html .= '
                <tr style="margin: 0; padding: 0;">
                    <td style="text-align: center; margin: 0; padding: 0; border-left: 1px solid black;">' . htmlspecialchars($rowtsp['clavea12'].$rowtsp['descripcionAP12t']) . '</td>
