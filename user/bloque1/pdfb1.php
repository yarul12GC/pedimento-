...
<td style="width: 16%;">' . htmlspecialchars($datodpm['anio_validacion'] . ' ' . $datodpm['clave_aduana'] . ' ' . $datodpm['patente'] . ' ' .  $datodpm['ultimo_digito_anio'] . $datodpm['numeracion_progresiva']) . '</td>
...
<td style="width: 15%;">' . htmlspecialchars($datodpm['clave_apendice2']) . '</td>
