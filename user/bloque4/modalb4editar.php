        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="decimal" class="form-control" id="edit-tipo-cambio-input" name="tipoCambioMXN" value="<?php echo $datosvp['tipoCambioMXN']; ?>" required oninput="calcularValoresEdicion()">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h5>TOTALES</h5>
                        <form id="edit-form1" action="../user/bloque4/editarDatosb4.php" method="post">
                            <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        ?>
                            <form id="edit-form2" action="../user/bloque6/editarDatosb6.php" method="post">
                    ...
                    <div class="col-md-4">
                        ...
                        ?>
                            <form id="edit-form3" action="../user/bloque7/editarDatosb7.php" method="post">
