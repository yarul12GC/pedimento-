<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class=" justify-content-center align-items-center flex-column">
                        <?php include '../user/cambio/tipocambio.php'; ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <form id="form1" action="../user/bloque6/insetardatosb6.php" method="post">
                        ...
                        <div class="col-md-4">
                            ...
                            <form id="form2" action="../user/bloque7/insertardatosb7.php" method="post">
                        ...
                        <div class="col-md-4">
                            <h5>TOTALES</h5>
                            <form id="form3" action="../user/bloque4/insertardatosb4.php" method="post">
                                <div class="form-group">
                                ...
                                <input type="hidden" name="idpedimentoc" value="<?php echo $pedimento_id; ?>">
                                <input type="hidden" id="hidden-tipo-cambio-form3" name="tipoCambioMXN">
                            </form>
                        </div>
                    </div>
    ...
    <script>
        function calcularValores() {
            ...
            document.getElementById('hidden-tipo-cambio-form1').value = tipoCambioMXN;
            document.getElementById('hidden-tipo-cambio-form2').value = tipoCambioMXN;
            document.getElementById('hidden-tipo-cambio-form3').value = tipoCambioMXN;
